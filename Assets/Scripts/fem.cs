...
public class fem : MonoBehaviour
{
    ...
    // hair style buttons
    public Button longHair, shortHair, wolfHair;
    ...
    public Image 
                 frontLongBrown, frontShortBrown, frontWolfBrown,
                frontLongPurple, frontShortPurple, frontWolfPurple,
                frontLongRed, frontShortRed, frontWolfRed,
        frontLongWhite, frontShortWhite, frontWolfWhite,

       
                 backLongBrown, backShortBrown, backWolfBrown,
                backLongPurple, backShortPurple, backWolfPurple,
                backLongRed, backShortRed, backWolfRed,
        backLongWhite, backShortWhite, backWolfWhite,
    ...
    void Start()
    {
       ...
       whiteHair.gameObject .SetActive(false);
        ...
        frontLongBrown.gameObject.SetActive(false);
        frontShortBrown.gameObject.SetActive(false);
        frontWolfBrown.gameObject.SetActive(false);
        frontLongPurple.gameObject.SetActive(false);
        frontShortPurple.gameObject.SetActive(false);
        frontWolfPurple.gameObject.SetActive(false);    
        frontLongRed.gameObject.SetActive(false);
        frontShortRed.gameObject.SetActive(false);
        frontWolfRed.gameObject.SetActive(false);
        
        backLongBrown.gameObject.SetActive(false);
        backShortBrown.gameObject.SetActive(false);
        backWolfBrown.gameObject.SetActive(false);
        backLongPurple.gameObject.SetActive(false);
        backShortPurple.gameObject.SetActive(false);
        backWolfPurple.gameObject.SetActive(false) ;
        backLongRed.gameObject.SetActive(false);
        backShortRed.gameObject.SetActive(false);
        backWolfRed.gameObject.SetActive(false);

        backLongWhite.gameObject.SetActive(true);
        backShortWhite.gameObject.SetActive(false);
        backWolfWhite.gameObject.SetActive(false) ;

        frontLongWhite.gameObject.SetActive(true);
        frontShortWhite.gameObject.SetActive(false ) ;
    ...
    // hair style
    // 0 = long, 1 = short, 2 = wolf

    void RemoveHairStyle()
    {
        if (hair == 0)
        {
            frontLongWhite.gameObject.SetActive(false);
            backLongWhite.gameObject.SetActive(false);
        }
    ...
    {
        RemoveHairStyle();
        frontShortWhite.gameObject.SetActive(true);
        backShortWhite.gameObject.SetActive(true);
    ...
    public void ClickBrownHair()
    {
        ...
        if (hair == 0)
        {
            frontLongBrown.gameObject.SetActive(true);
            backLongBrown.gameObject.SetActive(true);
        }
        else if (hair == 1)
        {
            frontShortBrown.gameObject.SetActive(true);
            backShortBrown.gameObject.SetActive(true);
        }
    ...
    public void ClickPurpleHair()
    {
        ...
        if (hair == 0)
        {
            frontLongPurple.gameObject.SetActive(true);
            backLongPurple.gameObject.SetActive(true);
        }
        else if (hair == 1)
        {
            frontShortPurple.gameObject.SetActive(true);
            backShortPurple.gameObject.SetActive(true);
        }
    ...
    public void ClickRedHair()
    {
        ...
        if (hair == 0)
        {
            frontLongRed.gameObject.SetActive(true);
            backLongRed.gameObject.SetActive(true);
        }
        else if (hair == 1)
        {
            frontShortRed.gameObject.SetActive(true);
            backShortRed.gameObject.SetActive(true);
        }
